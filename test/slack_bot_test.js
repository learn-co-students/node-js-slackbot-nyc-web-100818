...
let mockSlackPostData = {
  token: "79oeh0RzKNzyKSLP8yDPu0wB", // old test token doesn't exist
  team_id: "T02KU9PH6",
  ...
  command: "/github",
  response_url:
    "https://hooks.slack.com/commands/T02KU9PH6/41072273780/lodzbFlyr5UaQuev3NkHJYAN"
};
    ...
    request(baseUrl)
      ...
      .end((err, resp) => {
        ...
        expect(
          respObj.text,
          "to contain",
          "https://github.com/flatiron-school"
        );
        done();
      });
  });
